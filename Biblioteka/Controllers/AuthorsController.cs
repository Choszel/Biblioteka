...
namespace Biblioteka.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,name,surname,country,alias")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,name,surname,country,alias")] Author author)
        {
            if (id != author.id)
            {
                return NotFound();
